public class Lab203 {
    ...
    public static String[] addArraySize(String[] subjects) {
        String[] enlarge_array = new String[subjects.length + 1];
        for (int i = 0; i < subjects.length; i++) {
            enlarge_array[i] = subjects[i];
        }
        return enlarge_array;
    }

    public static String[] deleteElement(int index, String[] subjects) {
        String[] delete_array = new String[subjects.length - 1];
        int substitute = 0;
        ...
        for (int i = 0; i < subjects.length; i++) {
            ...
            delete_array[substitute] = subjects[i];
            substitute++;
        }
        return delete_array;
    }
